...
export default function EvaluationPage() {
  ...
  if (isLoading) {
    return (
      <div className="bg-gradient-to-b from-[#90a5d8] to-[#dbe4ee] flex flex-col items-center justify-center">
  ...
  return (
    <div className="bg-gradient-to-b from-[#5275A9] to-[#E6DDE4] flex flex-col">
      {/* Varnika Branding */}
